            ...
            <span class="flex justify-end items-center">
                <div class="flex gap-2">
                    <button @click="cancelChange()"
                        class="button w-[110px] text-center h-[38px] leading-[38px] border-[1px] border-[#b2b2b2] cursor-pointer">
                        Hủy bỏ
                    </button>
                    <button @click="doSubmit"
                        class="button w-[110px] text-center h-[38px] leading-[38px] border-[1px] text-[white] bg-[#d0011b] cursor-pointer">
                        Lưu
                    </button>
                </div>
            </span>
